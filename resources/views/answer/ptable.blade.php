<table class="table table-bordered" ng-keyup="$event.keyCode == 13 ? handleAnswer() : null"><tbody>
	...
	<tr><td ng-click="field.answer = '19'">19</td><td ng-click="field.answer = '20'">20</td><td colspan="3" rowspan="3" ng-click="field.answer = 'ETM'">ETM</td>
		<td colspan="2" rowspan="3" ng-click="field.answer = 'MTM'">MTM</td><td colspan="3" rowspan="3" ng-click="field.answer = 'LTM'">LTM</td>
