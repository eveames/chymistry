...
angular.module('chemiatriaApp')
  .service('ConversionListService', function () {
    ...
    {numUnitL: 'widgets', numUnit: 'widget', conversionNum: '', conversionDenom: 1, denomUnitL: 'package of widgets', denomUnit: 'package'},
    {numUnitL: 'packages of widgets', numUnit: 'package', conversionNum: '', conversionDenom: 1, denomUnitL: 'box of widgets', denomUnit: 'box of widgets'}],
